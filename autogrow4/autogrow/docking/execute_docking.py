...
def run_docking_common(vars, current_gen_int, current_generation_dir,
    ...
    dock_choice = vars["dock_choice"] # 对接工具选择
    conversion_choice = vars["conversion_choice"] # 格式转换工具
    ...
    # Docking the ligands which converted to PDBQT Find PDBQT's 对接转化为 PDBQT 的配体 查找 PDBQT
